...
gospider -s https://telekom.de -d 16 -a -w -c 50 | grep -oP '(http|https)://[^/"].*' | cut -d "]" -f1 | httpx -status-code -threads 500 | grep 200 | grep "=" | awk '{print $1}'| grep -v ".jpg\|.jpeg\|.gif\|.css\|.tif\|.tiff\|.png|.ttf\|.woff\|.
